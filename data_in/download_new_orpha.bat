...
for %f in (146,147,148,149,150,152,156,181,182,183,184,185,186,187,188,189,193,194,195,196,197,198,199,200,201,202,203,204,205,209,212,216,229,231,233) DO (curl -get http://www.orphadata.org/data/xml/en_product3_%f.xml > ./data_xml/en_product3_%f.xml)
